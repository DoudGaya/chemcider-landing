...
const Jobs = () => {
    return (
        <div className=" grid xl:grid-cols-2 py-[150px] space-y-6">
           <div className=" flex w-full space-y-4 flex-col px-10">
            <h3 className=" xl:text-2xl font-logo font-bold text-white ">Connecting Professionals with Quality Jobs</h3>
                <p className=" text-white xl:px-8 md:px-0 text-justify ">
                ...
                <div className=" py-10 ">
                    <Link href={'/jobs'} className=" text-white px-4 text-lg py-2 bg-gradient-to-r drop-shadow-2xl border-y border-slate-700 from-black via-slate-900 to-slate-900">
            ...
            <div className="grid sm:grid-cols-2 xl:py-10 gap-y-4 xl:gap-y-0 md:grid-cols-3 px-8 grid-cols-1 gap-x-6">
                <div className=" bg-gradient-to-r from-black to-slate-800 rounded-r-md h-[100px] border-r border-slate-600 flex flex-row items-center drop-shadow-2xl space-x-4 px-4 py-6">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 stroke-slate-400 h-8">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
                </svg>
                <p className=" text-slate-200">Technology</p>
                ...
                <p className=" text-slate-200">Science </p>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 stroke-slate-400 h-8">
                    ...
                    <p className=" text-slate-200">Engineering </p>              
                 </div>
