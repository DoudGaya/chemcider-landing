        ...
        <section className=" flex flex-col px-6 md:px-0 mb-10 ">
            <div className="grid grid-cols-1  md:grid-cols-2 gap-6">
                ...
                <div className=" items-center justify-center overflow-hidden flex md:py-10 md:px-10">
                    <Image src={comIMG} className=" object-contain hidden dark:block" alt="chemcider community" />
                    <Image src={comIMGDark} className=" object-contain dark:hidden" alt="chemcider community" />
                </div>
            </div>
        </section>
        </>
