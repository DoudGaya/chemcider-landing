...
const Modal = ({ closeModal }: ModalFunc) => {
    ...
    return (
        ...
        <ClickAwayListener onClickAway={ closeModal } >
            <div className=" w-full text-slate-900 md:w-2/5 h-[70vh] relative justify-between border border-[rgb(72,149,144)] drop-shadow-lg backdrop-blur-sm dark:bg-gradient-to-b dark:text-white dark:to-[#000A16] dark:from-[#021226]  text z-50 bg-gradient-to-br from-slate-200 to-white rounded-2xl my-auto mx-auto flex flex-col ">
