const Navigation = () => {
    return (
            ...
            <div className="">
                ...
                <p>Welcome to chemcider to <span className=" text-[rgb(34,176,196)] font-bold"> Chemcider Inc </span> We are currently upgrading our softwares to provide you with best User-Experience </p>
            </div>
            </div>
    )
}
