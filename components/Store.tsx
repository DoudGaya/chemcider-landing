            ...
            <div className=" grid grid-cols-1 md:grid-cols-2 md:gap-x-10 gap-y-4 px-6 ">
               <StoreImage />
                <div className=" md:px-6 flex flex-col justify-center">
                   ...
                   <Link href={'/store'} className=' w-full py-3 px-8 bg-[rgb(72,149,144)] dark:hover:bg-[rgb(72,149,144)]  text-white font-semibold dark:bg-purple-50/30 flex space-x-3 items-center'>
